  ...
  return (
    <form>
      <div className="new-expense__controls">
        ...
        <input type="text" onChange={titleChangeHandler} /></div>
        
        <div className="new-expense__control">  <label>Amount</label>
        <input  type="number" min="0.01" step="0.01" onChange={amountChangeHandler} /></div>
      
        <div className="new-expense__control"><label >Date</label>
        <input type="Date" min="2022-01-01" max="2023-12-31" onChange={dateChangeHandler}/></div>
